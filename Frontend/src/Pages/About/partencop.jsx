            ...
            <div className="container">
                ...
                <div className="row main-contteam-32 mt-sm-5 pt-lg-2">
                    {partenaires.map(partenaire => (
                        <div key={partenaire.id} className="col-lg-3 col-6 team-main-19 d-flex justify-content-center align-items-center mb-3">
                            <div className="column-19">
                                <a href={partenaire.lien}>
                                    <img className="img-fluid" style={{ width: "100px", height: "100px" }} src={`http://localhost:3001/photo/${partenaire.logo}`} alt={partenaire.nomSociete} />
                                </a>
                            </div>
                        </div>
                    ))}
