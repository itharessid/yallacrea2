    ...
    return (
        <div>
            <div className="printable-area" style={{ position: 'relative' }}>
                ...
                />*/}
<div style={{ position: "relative", display: "flex", justifyContent: "center", alignItems: "center", height: "800px" }}>
    <img src={`http://localhost:3001/certifications/exp.png`} alt="Certificat" style={{ width: "750px", height: "700px" }} />
    
    <div style={{ position: "absolute", top: "200px", left: "300px", fontFamily: "Adobe Garamond Pro", textTransform: "uppercase"}}>
        <p style={{ fontSize: '25px', color: '#690e68' }}><strong>{type}</strong></p>
    </div>
    <div style={{ position: "absolute", top: "350px", left: "345px" }}>
        <p style={{ fontSize: '25px', color: 'black' }}><strong>{nom.toUpperCase()} {prenom.charAt(0).toUpperCase() + prenom.slice(1)}</strong></p>
    </div>
    <div style={{ position: "absolute", top: "500px", left: "340px" }}>
