            ...
            <div className="main-container">
                <div className="row">
                    <button className="button1 noprint" style={{ marginRight: '10px' }}>
                        <Link to="/nattestation" className="dropdown-toggle">
                            <span className="mtext">Nouveau</span>
                        </Link>
                    </button>

                    <div className="printable-area" style={{ position: 'relative' }}>
                        <img src="src/Pages/Admin/Certification/certifications/attestation.png" alt="Description de l'image" style={{ width: "75%", marginLeft: "10px" }} />
                        ...
                        <div style={{ position: "absolute", top: "220px", left: "225px" }}>
                            <p style={{ fontSize: '15px', color: 'black' }}><strong>aaaaaaaaaaaaaaaa</strong></p>
                        </div>
