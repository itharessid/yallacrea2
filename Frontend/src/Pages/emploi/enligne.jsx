      ...
      <section className="w3l-breadcrumb">
        <div className="container">
          ...
          <div className="title-main text-center mx-auto mb-4">
            <h3 className="title-big"> Emplois du temps en ligne</h3>
            <p className="sub-title mt-2"><strong>Yalla Digital Academy</strong>  S'engage à fournir régulièrement des emplois en ligne actualisés à chaque semestre pour ses étudiants,
             ainsi qu'à maintenir les mises à jour sur le site web afin d'assurer l'accessibilité des emplois les plus récents.</p>
          </div>
        </div>
      </section>
    </div>  
